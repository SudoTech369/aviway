	...
	<div class="card-body">
		<form action="" id="product-form">
            ...
            <div class="form-group">
                ...
                <input type="number" name="price" id="price" class="form-control rounded-0" required value="<?php echo isset($price) ?$price : '' ?>" />
			</div>
            <div class="form-group">
				<label for="specs" class="control-label">About Product</label>
